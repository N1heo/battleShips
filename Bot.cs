...
namespace battleShipsFinalProject
{
    public class Bot
    {
        public int[,] myMap = new int[Form1.arrSize, Form1.arrSize];//bot`s map
        public int[,] enemyMap = new int[Form1.arrSize, Form1.arrSize];//player`s map

        public Button[,] myButtons = new Button[Form1.arrSize, Form1.arrSize];
        public Button[,] enemyButtons = new Button[Form1.arrSize, Form1.arrSize];
        ...
        {
            if (i < 0 || j < 0 || i >= Form1.arrSize || j >= Form1.arrSize)
            {
                return false;
            }
            return true;
        ...
        public int[,] ConfigureShips()
        {
            ...
            while (shipsCount > 0)
            {
                ...
                {
                    posX = r.Next(1, Form1.arrSize);
                    posY = r.Next(1, Form1.arrSize);
        ...
        public bool Shoot()
        {
            ...
            int posX = r.Next(1, Form1.arrSize);
            int posY = r.Next(1, Form1.arrSize);
